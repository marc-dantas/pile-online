...
export default function Docs() {
    return (
        <DocsPage>
            ...
            <P>In Pile, everything revolves around the stack. The stack is like a list or a container that holds data. It&apos;s called a stack because it operates in a very specific way: last in, first out (LIFO). Imagine a stack of plates. You can only add or remove plates from the top of the stack, not from the middle or bottom.</P>
